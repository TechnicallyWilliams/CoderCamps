...
namespace WishHeroes
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            var emailUsername = ConfigurationManager.AppSettings["EmailUser"];
            var emailPassword = ConfigurationManager.AppSettings["EmailPass"];
            ...
            try
            {
                MailMessage email = new MailMessage(emailUsername, message.Destination);
